...
public class KeSach {
    ...
    private List<ViTriKeSach> viTriKeSachs;

    @Transient
    private Integer currentBooks; // Số sách hiện tại trên kệ, không lưu vào DB
    ...
    public List<ViTriKeSach> getViTriKeSachs() { return viTriKeSachs; }
    public void setViTriKeSachs(List<ViTriKeSach> viTriKeSachs) { this.viTriKeSachs = viTriKeSachs; }
    public Integer getCurrentBooks() { return currentBooks; }
